...
type: pbl
week: 33
nb_path: _notebooks/2023-05-31-PBL-javascript_tutorial.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2023-05-31-PBL-javascript_tutorial.ipynb
-->
...
<div id="e8453482-9f30-4a80-b099-5e529aea7b75"></div>
<div class="output_subarea output_javascript ">
<script type="text/javascript">
var element = $('#e8453482-9f30-4a80-b099-5e529aea7b75');
...
<div id="9c0910ba-f27e-48b7-a7ae-a952618706b3"></div>
<div class="output_subarea output_javascript ">
<script type="text/javascript">
var element = $('#9c0910ba-f27e-48b7-a7ae-a952618706b3');
...
<span class="kd">var</span> <span class="nx">classOf</span> <span class="o">=</span> <span class="s2">&quot;Welcome DNHS class of 2024.&quot;</span>
...
<div id="d5105fe9-9ff0-48cc-9d08-c03ae28022d7"></div>
<div class="output_subarea output_javascript ">
<script type="text/javascript">
var element = $('#d5105fe9-9ff0-48cc-9d08-c03ae28022d7');
...
var classOf = "Welcome DNHS class of 2024."
...
<span class="nx">logIt</span><span class="p">(</span><span class="s2">&quot;This is a string&quot;</span><span class="p">);</span> <span class="c1">// String</span>
<span class="nx">logIt</span><span class="p">(</span><span class="mf">2</span><span class="p">);</span>    <span class="c1">// Number</span>
...
<span class="kd">var</span> <span class="nx">person</span> <span class="o">=</span> <span class="p">{</span> <span class="c1">// key:value pairs seperated by comma</span>
    <span class="s2">&quot;name&quot;</span><span class="o">:</span> <span class="s2">&quot;Grace Wang&quot;</span><span class="p">,</span> 
    <span class="s2">&quot;role&quot;</span><span class="o">:</span> <span class="s2">&quot;Student&quot;</span>
<span class="p">};</span> 
...
<div id="bda0c433-5257-4cbc-94ec-e1194a623184"></div>
<div class="output_subarea output_javascript ">
<script type="text/javascript">
var element = $('#bda0c433-5257-4cbc-94ec-e1194a623184');
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="o">%%js</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s2">&quot;Music objects&quot;</span><span class="p">);</span>

<span class="cm">/* class: Person</span>
<span class="cm"> * Description: A collection of Person data</span>
<span class="cm">*/</span>
<span class="kr">class</span> <span class="nx">Music</span> <span class="p">{</span>
...
<span class="cm">  */</span>
  <span class="nx">constructor</span><span class="p">(</span><span class="nx">song</span><span class="p">,</span> <span class="nx">artist</span><span class="p">,</span> <span class="nx">release</span><span class="p">,</span> <span class="nx">role</span><span class="o">=</span><span class="s2">&quot;music&quot;</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">this</span><span class="p">.</span><span class="nx">release</span> <span class="o">=</span> <span class="nx">release</span><span class="p">;</span>
...
<span class="cm">  */</span>
  <span class="nx">getJSON</span><span class="p">()</span> <span class="p">{</span>
    <span class="kr">const</span> <span class="nx">obj</span> <span class="o">=</span> <span class="p">{</span><span class="nx">type</span><span class="o">:</span> <span class="k">typeof</span> <span class="k">this</span><span class="p">,</span> <span class="nx">song</span><span class="o">:</span> <span class="k">this</span><span class="p">.</span><span class="nx">song</span><span class="p">,</span> <span class="nx">artist</span><span class="o">:</span> <span class="k">this</span><span class="p">.</span><span class="nx">artist</span><span class="p">,</span> <span class="nx">release</span><span class="o">:</span> <span class="k">this</span><span class="p">.</span><span class="nx">classOf</span><span class="p">,</span> <span class="nx">role</span><span class="o">:</span> <span class="k">this</span><span class="p">.</span><span class="nx">role</span><span class="p">};</span>
...
<span class="c1">// make a new Music Object</span>
<span class="kr">const</span> <span class="nx">ts</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Music</span><span class="p">(</span><span class="s2">&quot;Love Story&quot;</span><span class="p">,</span> <span class="s2">&quot;Taylor Swift&quot;</span><span class="p">,</span> <span class="mf">2010</span><span class="p">);</span> <span class="c1">// object type is easy to work with in JavaScript</span>
<span class="nx">ts</span><span class="p">.</span><span class="nx">setRole</span><span class="p">(</span><span class="s2">&quot;pop&quot;</span><span class="p">);</span> <span class="c1">// set the role</span>
<span class="nx">ts</span><span class="p">.</span><span class="nx">logIt</span><span class="p">();</span>  <span class="c1">// log to console</span>

<span class="c1">// make a new Music Object</span>
<span class="kr">const</span> <span class="nx">ob</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Music</span><span class="p">(</span><span class="s2">&quot;Dead Man&#39;s Party&quot;</span><span class="p">,</span> <span class="s2">&quot;Oingo Boingo&quot;</span><span class="p">,</span> <span class="mf">1985</span><span class="p">);</span> <span class="c1">// object type is easy to work with in JavaScript</span>
<span class="nx">ob</span><span class="p">.</span><span class="nx">setRole</span><span class="p">(</span><span class="s2">&quot;rock&quot;</span><span class="p">);</span> <span class="c1">// set the role</span>
<span class="nx">ob</span><span class="p">.</span><span class="nx">logIt</span><span class="p">();</span> <span class="c1">// log to console</span>
</pre></div>
...
<div id="f8316d8a-eec9-4fd9-b10b-1f3077fb6dcb"></div>
<div class="output_subarea output_javascript ">
<script type="text/javascript">
var element = $('#f8316d8a-eec9-4fd9-b10b-1f3077fb6dcb');
console.log("Music objects");
...
class Music {
  ...
  */
  constructor(song, artist, release, role="music") {
    this.song = song;
    this.artist = artist;
  ...
  */
  getJSON() {
    const obj = {type: typeof this, song: this.song, artist: this.artist, release: this.classOf, role: this.role};
...
const ts = new Music("Love Story", "Taylor Swift", 2010); // object type is easy to work with in JavaScript
ts.setRole("pop"); // set the role
ts.logIt();  // log to console

// make a new Music Object
const ob = new Music("Dead Man's Party", "Oingo Boingo", 1985); // object type is easy to work with in JavaScript
ob.setRole("rock"); // set the role
ob.logIt(); // log to console
...
<span class="p">}</span>
<span class="cm">/* class: Genre</span>
<span class="cm"> * Description: A collection of Person objects</span>
<span class="cm">*/</span>
<span class="kr">class</span> <span class="nx">Genre</span> <span class="p">{</span>
  <span class="cm">/* method: constructor</span>
...
<span class="cm">  */</span>
  <span class="nx">constructor</span><span class="p">(</span><span class="nx">music</span><span class="p">)</span> <span class="p">{</span>
...
<span class="cm">    */</span>
    <span class="k">this</span><span class="p">.</span><span class="nx">music</span> <span class="o">=</span> <span class="nx">music</span><span class="p">;</span>
    <span class="k">this</span><span class="p">.</span><span class="nx">list</span> <span class="o">=</span> <span class="p">[...</span><span class="nx">music</span><span class="p">];</span> <span class="c1">// ... spread option</span>
    <span class="k">this</span><span class="p">.</span><span class="nx">json</span> <span class="o">=</span> <span class="s1">&#39;{&quot;music taste&quot;:[&#39;</span> <span class="o">+</span> <span class="k">this</span><span class="p">.</span><span class="nx">list</span><span class="p">.</span><span class="nx">map</span><span class="p">(</span><span class="nx">music</span> <span class="p">=&gt;</span> <span class="nx">music</span><span class="p">.</span><span class="nx">getJSON</span><span class="p">())</span> <span class="o">+</span> <span class="s1">&#39;]}&#39;</span><span class="p">;</span>
  <span class="p">}</span>
...
<span class="cm">  */</span>
  <span class="nx">logIt</span><span class="p">()</span> <span class="p">{</span>
    ...
    <span class="nx">element</span><span class="p">.</span><span class="nx">append</span><span class="p">(</span><span class="s2">&quot;Music object in JSON&lt;br&gt;&quot;</span><span class="p">);</span>
...
<span class="kd">function</span> <span class="nx">constructCompSciClassroom</span><span class="p">()</span> <span class="p">{</span>
    ...
    <span class="kr">const</span> <span class="nx">music</span> <span class="o">=</span> <span class="p">[</span> 
      <span class="k">new</span> <span class="nx">Music</span><span class="p">(</span><span class="s2">&quot;Hits Different&quot;</span><span class="p">,</span> <span class="s2">&quot;Taylor Swift&quot;</span><span class="p">,</span> <span class="mf">2023</span><span class="p">,</span> <span class="s2">&quot;pop&quot;</span><span class="p">),</span>
      <span class="k">new</span> <span class="nx">Music</span><span class="p">(</span><span class="s2">&quot;Anti Hero&quot;</span><span class="p">,</span> <span class="s2">&quot;Taylor Swift&quot;</span><span class="p">,</span> <span class="mf">2022</span><span class="p">,</span> <span class="s2">&quot;rock&quot;</span><span class="p">),</span>
      <span class="k">new</span> <span class="nx">Music</span><span class="p">(</span><span class="s2">&quot;Buttercup&quot;</span><span class="p">,</span> <span class="s2">&quot;Hippo Campus&quot;</span><span class="p">,</span> <span class="mf">2020</span><span class="p">,</span> <span class="s2">&quot;Indie&quot;</span><span class="p">),</span>
      <span class="k">new</span> <span class="nx">Music</span><span class="p">(</span><span class="s2">&quot;Sweet Talk&quot;</span><span class="p">,</span> <span class="s2">&quot;Saint Motel&quot;</span><span class="p">,</span> <span class="mf">2020</span><span class="p">,</span> <span class="s2">&quot;Indie&quot;</span><span class="p">),</span>
      <span class="k">new</span> <span class="nx">Music</span><span class="p">(</span><span class="s2">&quot;Matilda&quot;</span><span class="p">,</span> <span class="s2">&quot;Harry Styles&quot;</span><span class="p">,</span> <span class="mf">2020</span><span class="p">,</span> <span class="s2">&quot;pop&quot;</span><span class="p">),</span>
      <span class="k">new</span> <span class="nx">Music</span><span class="p">(</span><span class="s2">&quot;21&quot;</span><span class="p">,</span> <span class="s2">&quot;Gracie Abrams&quot;</span><span class="p">,</span> <span class="mf">2022</span><span class="p">,</span> <span class="s2">&quot;pop&quot;</span><span class="p">)</span>
    <span class="p">];</span>

    <span class="c1">// make a CompSci classroom from formerly defined teacher and student objects</span>
    <span class="k">return</span> <span class="k">new</span> <span class="nx">Genre</span><span class="p">(</span><span class="nx">music</span><span class="p">);</span>  <span class="c1">// returns object</span>
<span class="p">}</span>
...
<div id="19e1ebaa-6162-48b5-a4bd-e84d7bfb0cb4"></div>
<div class="output_subarea output_javascript ">
<script type="text/javascript">
var element = $('#19e1ebaa-6162-48b5-a4bd-e84d7bfb0cb4');
console.log("Music objects");
...
class Genre {
  ...
  */
  constructor(music) {
    ...
    */
    this.music = music;
    this.list = [...music]; // ... spread option
    this.json = '{"music taste":[' + this.list.map(music => music.getJSON()) + ']}';
  }
  ...
  */
  logIt() {
    ...
    //Classroom json
    element.append("Music object in JSON<br>");
...
function constructCompSciClassroom() {
    ...
    const music = [ 
      new Music("Hits Different", "Taylor Swift", 2023, "pop"),
      new Music("Anti Hero", "Taylor Swift", 2022, "rock"),
      new Music("Buttercup", "Hippo Campus", 2020, "Indie"),
      new Music("Sweet Talk", "Saint Motel", 2020, "Indie"),
      new Music("Matilda", "Harry Styles", 2020, "pop"),
      new Music("21", "Gracie Abrams", 2022, "pop")
    ];

    // make a CompSci classroom from formerly defined teacher and student objects
    return new Genre(music);  // returns object
}
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="o">%%js</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s2">&quot;Grace&#39;s Music&quot;</span><span class="p">);</span>
...
<span class="kr">const</span> <span class="nx">list</span> <span class="o">=</span> <span class="nx">JSON</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">jsonText</span><span class="p">).</span><span class="nx">list</span><span class="p">;</span>
...
<span class="k">for</span> <span class="p">(</span><span class="kd">var</span> <span class="nx">row</span> <span class="k">of</span> <span class="nx">list</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">element</span><span class="p">.</span><span class="nx">append</span><span class="p">(</span><span class="nx">row</span><span class="p">.</span><span class="nx">artist</span> <span class="o">+</span> <span class="s2">&quot; &quot;</span> <span class="o">+</span> <span class="nx">row</span><span class="p">.</span><span class="nx">song</span> <span class="o">+</span> <span class="s1">&#39;&lt;br&gt;&#39;</span><span class="p">);</span>
    ...
    <span class="nx">$</span><span class="p">(</span><span class="s1">&#39;#classroom&#39;</span><span class="p">).</span><span class="nx">append</span><span class="p">(</span><span class="s1">&#39;&lt;td&gt;&#39;</span> <span class="o">+</span> <span class="nx">row</span><span class="p">.</span><span class="nx">song</span> <span class="o">+</span> <span class="s1">&#39;&lt;/td&gt;&#39;</span><span class="p">)</span>
    ...
    <span class="nx">$</span><span class="p">(</span><span class="s1">&#39;#classroom&#39;</span><span class="p">).</span><span class="nx">append</span><span class="p">(</span><span class="s1">&#39;&lt;td&gt;&#39;</span> <span class="o">+</span> <span class="nx">row</span><span class="p">.</span><span class="nx">release</span> <span class="o">+</span> <span class="s1">&#39;&lt;/td&gt;&#39;</span><span class="p">)</span>
...
<div id="c7f4de06-521c-4a94-aa6b-10ae8df88ca6"></div>
<div class="output_subarea output_javascript ">
<script type="text/javascript">
var element = $('#c7f4de06-521c-4a94-aa6b-10ae8df88ca6');
console.log("Grace's Music");
...
<span class="p">&lt;</span><span class="nt">table</span> <span class="na">id</span><span class="o">=</span><span class="s">&quot;flaskTable&quot;</span> <span class="na">class</span><span class="o">=</span><span class="s">&quot;table&quot;</span> <span class="na">style</span><span class="o">=</span><span class="s">&quot;width:100%&quot;</span><span class="p">&gt;</span>
    <span class="p">&lt;</span><span class="nt">thead</span> <span class="na">id</span><span class="o">=</span><span class="s">&quot;flaskHead&quot;</span><span class="p">&gt;</span>
        <span class="p">&lt;</span><span class="nt">tr</span><span class="p">&gt;</span>
            <span class="p">&lt;</span><span class="nt">th</span><span class="p">&gt;</span>Food<span class="p">&lt;/</span><span class="nt">th</span><span class="p">&gt;</span>
            <span class="p">&lt;</span><span class="nt">th</span><span class="p">&gt;</span>Ingredients<span class="p">&lt;/</span><span class="nt">th</span><span class="p">&gt;</span>
            <span class="p">&lt;</span><span class="nt">th</span><span class="p">&gt;</span>Servings<span class="p">&lt;/</span><span class="nt">th</span><span class="p">&gt;</span>
            <span class="p">&lt;</span><span class="nt">th</span><span class="p">&gt;</span>Instructions<span class="p">&lt;/</span><span class="nt">th</span><span class="p">&gt;</span>
        <span class="p">&lt;/</span><span class="nt">tr</span><span class="p">&gt;</span>
    <span class="p">&lt;/</span><span class="nt">thead</span><span class="p">&gt;</span>
...
<span class="p">&lt;</span><span class="nt">script</span><span class="p">&gt;</span>
  <span class="nx">$</span><span class="p">(</span><span class="nb">document</span><span class="p">).</span><span class="nx">ready</span><span class="p">(</span><span class="kd">function</span><span class="p">()</span> <span class="p">{</span>
    <span class="nx">fetch</span><span class="p">(</span><span class="s1">&#39;https://ated.duckdns.org/api/recipe/&#39;</span><span class="p">,</span> <span class="p">{</span> <span class="nx">mode</span><span class="o">:</span> <span class="s1">&#39;cors&#39;</span> <span class="p">})</span>
    ...
    <span class="p">.</span><span class="nx">then</span><span class="p">(</span><span class="nx">data</span> <span class="p">=&gt;</span> <span class="p">{</span>
      <span class="k">for</span> <span class="p">(</span><span class="kr">const</span> <span class="nx">row</span> <span class="k">of</span> <span class="nx">data</span><span class="p">)</span> <span class="p">{</span>
        ...
        <span class="nx">$</span><span class="p">(</span><span class="s1">&#39;#flaskBody&#39;</span><span class="p">).</span><span class="nx">append</span><span class="p">(</span><span class="s1">&#39;&lt;tr&gt;&lt;td&gt;&#39;</span> <span class="o">+</span> 
            ...
            <span class="nx">row</span><span class="p">.</span><span class="nx">ingredients</span> <span class="o">+</span> <span class="s1">&#39;&lt;/td&gt;&lt;td&gt;&#39;</span> <span class="o">+</span> 
            <span class="nx">row</span><span class="p">.</span><span class="nx">servings</span> <span class="o">+</span> <span class="s1">&#39;&lt;/td&gt;&lt;td&gt;&#39;</span> <span class="o">+</span> 
            <span class="nx">row</span><span class="p">.</span><span class="nx">instructions</span> <span class="o">+</span> <span class="s1">&#39;&lt;/td&gt;&lt;/tr&gt;&#39;</span><span class="p">);</span>
      <span class="p">}</span>
...
<script>
  $(document).ready(function() {
    fetch('https://ated.duckdns.org/api/recipe/', { mode: 'cors' })
    .then(response => {
      if (!response.ok) {
    ...
    .then(data => {
      for (const row of data) {
        ...
        $('#flaskBody').append('<tr><td>' + 
            row.title + '</td><td>' + 
            row.ingredients + '</td><td>' + 
            row.servings + '</td><td>' + 
            row.instructions + '</td></tr>');
      }
